      ...
      <header className={styles.headerWrap}>
        <div className={styles.header}>
          <svg
            ...
            <path d="M26.6585 12.8253V14.3453H25.1385V15.8753H23.6085V18.9253H25.1385V21.9653H22.0885V23.4953H25.1385V25.0153H29.7085V26.5353H31.2285V23.4953H32.7585V18.9253H31.2285V15.8753H29.7085V12.8253H26.6585Z" fill="#000001" />
            <path d="M29.7085 26.5352H28.1785V28.0652H29.7085V26.5352Z" fill="#000001" />
            <path d="M28.1785 28.0652H26.6585V29.5852H28.1785V28.0652Z" fill="#000001" />
            <path d="M26.6585 29.5853H22.0885V31.1153H26.6585V29.5853Z" fill="#000001" />
            <path d="M25.1385 5.20524V11.3052H26.6585V2.15524H25.1385V3.68524H23.6085V5.20524H25.1385Z" fill="#000001" />
            <path d="M19.0385 11.3052V8.25525H17.5185V11.3052H15.9885V12.8252H25.1385V11.3052H19.0385Z" fill="#000001" />
            <path d="M23.6085 2.15524H22.0885V3.68524H23.6085V2.15524Z" fill="#000001" />
            <path d="M22.0885 31.1153H20.5585V32.6353H22.0885V31.1153Z" fill="#000001" />
            <path d="M22.0885 20.4453H20.5585V21.9653H22.0885V20.4453Z" fill="#000001" />
            <path d="M20.5585 29.5853H19.0385V31.1153H20.5585V29.5853Z" fill="#000001" />
            <path d="M20.5585 21.9652H19.0385V23.4952H20.5585V21.9652Z" fill="#000001" />
            <path d="M19.0385 28.0652H17.5185V29.5852H19.0385V28.0652Z" fill="#000001" />
            <path d="M19.0385 23.4952H17.5185V25.0152H19.0385V23.4952Z" fill="#000001" />
            <path d="M17.5185 25.0153H15.9885V28.0653H17.5185V25.0153Z" fill="#000001" />
            <path d="M17.5185 6.72525H15.9885V8.25525H17.5185V6.72525Z" fill="#000001" />
            <path d="M5.32855 11.3053H8.36855V12.8253H11.4185V11.3053H12.9485V9.77525H14.4685V6.72525H15.9885V3.68525H14.4685V2.15525H22.0885V0.635254H8.36855V2.15525H6.84855V3.68525H5.32855V6.72525H3.79855V9.77525H5.32855V11.3053Z" fill="#000001" />
            <path d="M8.36855 25.0152H6.84855V26.5352H5.32855V28.0652H3.79855V29.5852H5.32855V31.1152H6.84855V32.6352H14.4685V25.0152H9.89855V21.9652H8.36855V25.0152Z" fill="#000001" />
            <path d="M11.4185 20.4452H9.89854V21.9652H11.4185V23.4952H12.9485V15.8752H11.4185V20.4452Z" fill="#000001" />
            <path d="M5.32855 15.8752H11.4185V14.3452H2.27855V15.8752H3.79855V17.3952H5.32855V15.8752Z" fill="#000001" />
            <path d="M3.79855 25.0153H2.27855V28.0653H3.79855V25.0153Z" fill="#000001" />
            <path d="M3.79855 17.3953H2.27855V20.4453H3.79855V17.3953Z" fill="#000001" />
            <path d="M2.27854 20.4453H0.758545V25.0153H2.27854V20.4453Z" fill="#000001" />
          </svg>
